...
const ThemeLayout = (WrappedComponent) => {
  class LayoutComponent extends Component {
    ...
    render() {
      const { collapsed, hide, searchHide, activeSearch, customizerAction } =
        this.state;
      const {
        ChangeLayoutMode,
        rtl,
      ...
      const ContentStyle = {
        marginLeft: !collapsed ? (!rtl ? "280px" : "0") : (!rtl ? "80px" : "0"),
        marginRight: !collapsed ? (rtl ? "280px" : "0") : (rtl ? "80px" : "0"),
        transition: "all 0.3s ease",
        "@media (max-width: 991px)": {
          marginLeft: 0,
          marginRight: 0,
        ...
        <Div darkMode={darkMode}>
          <Layout className="layout">
            ...
            <Layout>
              ...
              <Layout className="atbd-main-layout" style={ContentStyle}>
                <Content>
                    ...
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">
                          {this.state.currentYear} © Tawsilet Technologies
                        </span>
                      </Col>
                      <Col md={12} xs={24}>
                        <div className="admin-footer__links">
                          <NavLink to="#">À propos</NavLink>
                          <NavLink to="#">Équipe</NavLink>
