          ...
          <Row className="justify-content-center" gutter={25}>
            <Col className="trigger-col" xxl={5} xl={7} lg={9} xs={24}>
              {responsive <= 991 && (
                ...
                >
                  <FeatherIcon
                    icon={collapsed ? "align-left" : "align-right"}
                  />
                </Button>
              )}
              {responsive > 991 ? (
                  ...
                  <Cards headless>
                    <div className="note-sidebar-top">
                      <Button
                        ...
                        block
                      >
                        <FeatherIcon icon="plus" size={18} /> Ajouter des notes
                      </Button>
                    </div>
                          ...
                          <ul>
                            <li>
                              <NavLink to={`${path}/personal`}>
                                <Bullet className="personal" /> Personnel
                              </NavLink>
                            </li>
                            <li>
                              <Link to={`${path}/work`}>
                                <Bullet className="work" /> Travail
                              </Link>
                            </li>
                            <li>
                              <Link to={`${path}/social`}>
              ...
              <Form form={form} name="createProject" onFinish={handleOk}>
                <Form.Item
                  rules={[
                    {
                      required: true,
                      message: "Please input your note title!",
                    },
                  ]}
                  name="title"
                  label="Title"
                ...
                <Form.Item
                  rules={[
                    {
                      required: true,
                      message: "Please input your note description!",
                    },
                  ]}
                  name="description"
                  label="Description"
