...
const Reservations = ({ textFilter, filterStatus, dateSortBy, dateFilter }) => {
  ...
  //     })
  //   );
  // }, [textFilter, filterStatus, dateSortBy, dateFilter]);
  ...
  const dataSource = reservations
    ? reservations
        // .filter((el) => el?.company_id?.data === null)
        // ?.filter((data) => {
        //   const id = data?.id;
        //   const pickupAddress = data?.pickUpAddress?.Address;
        //   const deliveryAddress = data?.dropOfAddress?.Address;
        //   const date = data?.departDate;
        //   const idClient = data?.totalPrice;
        //   const price = data?.totalPrice;
        //   const payType = data?.payType;
        //   const commandStatus = data?.commandStatus;

        //   return (
        //     id?.toString().toLowerCase().includes(textFilter.toLowerCase()) ||
        //     pickupAddress?.toLowerCase().includes(textFilter.toLowerCase()) ||
        //     deliveryAddress?.toLowerCase().includes(textFilter.toLowerCase()) ||
        //     date?.toLowerCase().includes(textFilter.toLowerCase()) ||
        //     idClient
        //       ?.toString()
        //       .toLowerCase()
        ...
        //       .toLowerCase()
        //       .includes(textFilter.toLowerCase()) ||
        //     payType?.toLowerCase().includes(textFilter.toLowerCase()) ||
        //     commandStatus?.toLowerCase()?.includes(textFilter.toLowerCase())
        //   );
        // })
        // .reverse()
        .map((value, i) => ({
